...
// DON'T CHANGE THESE:
  ...
  bbs.calibration_image_scale = 3.614;
  bbs.focal_length = 478.59925;
  bbs.radial_distortion_coeff[0] = -0.2958;
  bbs.radial_distortion_coeff[1] = 0.1032;
  bbs.distortion_center[0] = 552.8043;
  bbs.distortion_center[1] = 389.2484;
